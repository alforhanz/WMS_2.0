...
<header id="header" class="page-topbar">
      ...
      <div class="row">
        <div class="col s11">
          <div class="row buscador">
            ...
            <div class="s2 col">
              <button id="buscado" class="search-action ui-btn" onclick="javascript: busquedaGeneral('W','')">
    ...
    <div id="bodega_sucursales" class="modal">
      <div class="modal-content">
        ...
        <!-- AQUI SE CARGAN LA DATA DE LAS SUCURSALES -->
        <div id="carga_more_sucursales"></div>
      </div>
    </div>
    <!-- FIN BODEGAS Y SUCURSALES -->
    ...
    <div class="sidenav" id="mobile-demo">
      <div class="row bordered">
        <div class="col s6 m6">
          ...
          <span id="usuario" class="hide-on-med-and-downx " style="color: #000 ;"></span>
