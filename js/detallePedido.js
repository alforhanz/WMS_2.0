    ...
    if (detalle.CANTIDAD_VERIFICADA != null && detalle.CANTIDAD_VERIFICADA !== "") { // Verificar si CANTIDAD_VERIFICADA tiene un valor
      ...
      newRow.innerHTML = `
        ...
        <td class="codigo-barras-cell2">
            <input id="cant-pedida" type="text" class="codigo-barras-input" value="${detalle.CANTIDAD_VERIFICADA || ''}" onchange="guardarTablaEnArray(this)" style="text-align: center;" ${disabled}>
        </td>
        <td class="codigo-barras-cell2">
